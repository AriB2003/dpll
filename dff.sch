...
N 110 10 120 10 {lab=#net2}
N 0 10 50 10 {lab=nQI}
N 260 -20 320 -20 {lab=Q}
N 200 10 250 10 {lab=#net3}
...
C {code_shown.sym} -140 -170 0 0 {name=SPICE1 only_toplevel=false value="
.param inv_wid=0.5 inv_len=0.15
"}
C {inverter.sym} -30 -20 0 0 {name=X3}
C {lab_pin.sym} 30 -40 1 0 {name=p31 sig_type=std_logic lab=VP}
C {lab_pin.sym} 30 0 3 0 {name=p32 sig_type=std_logic lab=VN}
C {inverter.sym} 20 10 0 0 {name=X4}
C {lab_pin.sym} 80 -10 1 0 {name=p5 sig_type=std_logic lab=VP}
C {lab_pin.sym} 80 30 3 0 {name=p6 sig_type=std_logic lab=VN}
C {lab_pin.sym} 50 60 3 0 {name=p7 sig_type=std_logic lab=VN}
C {lab_pin.sym} 50 -100 1 0 {name=p8 sig_type=std_logic lab=VP}
C {inverter.sym} 170 -20 0 0 {name=X5}
C {lab_pin.sym} 230 -40 1 0 {name=p9 sig_type=std_logic lab=VP}
C {lab_pin.sym} 230 0 3 0 {name=p10 sig_type=std_logic lab=VN}
C {inverter.sym} 220 10 0 0 {name=X6}
C {lab_pin.sym} 280 -10 1 0 {name=p11 sig_type=std_logic lab=VP}
C {lab_pin.sym} 280 30 3 0 {name=p12 sig_type=std_logic lab=VN}
