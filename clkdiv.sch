...
N 70 -100 70 -20 {lab=#net2}
N 60 10 60 50 {lab=#net1}
N -10 40 -10 50 {lab=clkin}
N 70 50 90 50 {lab=#net1}
N -40 50 -10 50 {lab=clkin}
N 180 10 190 10 {lab=#net3}
N 190 -80 190 10 {lab=#net3}
N 90 -80 190 -80 {lab=#net3}
N 90 -80 90 -20 {lab=#net3}
N 90 -20 100 -20 {lab=#net3}
N 180 -20 200 -20 {lab=#net4}
N 200 -100 200 -20 {lab=#net4}
N 190 10 190 50 {lab=#net3}
N 120 40 120 50 {lab=#net1}
N 200 50 220 50 {lab=#net3}
N 90 50 120 50 {lab=#net1}
N 310 10 320 10 {lab=#net5}
N 320 -80 320 10 {lab=#net5}
N 220 -80 320 -80 {lab=#net5}
N 220 -80 220 -20 {lab=#net5}
N 220 -20 230 -20 {lab=#net5}
N 310 -20 330 -20 {lab=#net6}
N 330 -100 330 -20 {lab=#net6}
N 250 40 250 50 {lab=#net3}
N 220 50 250 50 {lab=#net3}
N -180 30 -160 30 {lab=d4}
N -180 50 -160 50 {lab=d8}
N 190 50 200 50 {lab=#net3}
N 60 50 70 50 {lab=#net1}
N -50 -90 70 -90 {lab=#net2}
N -50 -90 -50 10 {lab=#net2}
N -50 10 -30 10 {lab=#net2}
N 80 10 100 10 {lab=#net4}
N 80 -90 80 10 {lab=#net4}
N 80 -90 200 -90 {lab=#net4}
N 210 10 230 10 {lab=#net6}
N 210 -90 210 10 {lab=#net6}
N 210 -90 330 -90 {lab=#net6}
...
C {lab_pin.sym} 70 -160 1 0 {name=p3 sig_type=std_logic lab=d2}
...
C {lab_pin.sym} 200 -160 1 0 {name=p7 sig_type=std_logic lab=d4}
...
C {lab_pin.sym} 330 -160 1 0 {name=p10 sig_type=std_logic lab=d8}
...
C {inverter.sym} 70 -70 3 0 {name=X4}
C {lab_pin.sym} 90 -130 1 0 {name=p22 sig_type=std_logic lab=VN}
C {lab_pin.sym} 50 -130 1 0 {name=p23 sig_type=std_logic lab=VP}
C {inverter.sym} 200 -70 3 0 {name=X5}
C {lab_pin.sym} 220 -130 1 0 {name=p15 sig_type=std_logic lab=VN}
C {lab_pin.sym} 180 -130 1 0 {name=p16 sig_type=std_logic lab=VP}
C {inverter.sym} 330 -70 3 0 {name=X6}
C {lab_pin.sym} 350 -130 1 0 {name=p17 sig_type=std_logic lab=VN}
C {lab_pin.sym} 310 -130 1 0 {name=p18 sig_type=std_logic lab=VP}
