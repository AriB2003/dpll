...
logx=0
logy=0
rawfile=$netlist_dir/test_postlayout_w_passive.raw}
...
.include ~/Documents/dpll/layout/pasdpll.spice
.tran 1n 25u
.ic v(Vvco) = 0.915
.save all
"}
C {madvlsi/gnd.sym} 0 -130 0 0 {name=l4 lab=GND}
C {lab_pin.sym} -80 -150 3 0 {name=p2 sig_type=std_logic lab=Vvco}
C {madvlsi/vsource.sym} 350 -250 0 0 {name=Vvco
value=0.915}
C {madvlsi/gnd.sym} 350 -220 0 0 {name=l1 lab=GND}
C {lab_pin.sym} 350 -280 0 0 {name=p3 sig_type=std_logic lab=Vstart}
C {madvlsi/nmos3.sym} -120 -150 1 0 {name=M1
L=0.15
W=1
body=GND
nf=1
...
C {lab_pin.sym} -150 -150 0 0 {name=p4 sig_type=std_logic lab=Vstart}
...
C {lab_pin.sym} -120 -180 0 0 {name=p6 sig_type=std_logic lab=Vup}
...
C {/home/madvlsi/Documents/dpll/LDS/pasdpll.sym} 0 -160 0 0 {name=X1}
